...
<div class="content">
                ...
                <div class="new-itens-content card">
                    <h4> <i class="fab fa-microitens"></i> Podcast</h4>
...
export default {
    ...
    data() {
        return {
            ...
            filtroDescricao: '',
            itens: [
                { id: 1, titulo: 'Aquariano ', descricao:'Áudio de 2 Minutos' , assunto:'Poesia recitada'},
                { id: 2, titulo: ' Gênesis', descricao: 'Áudio de 1,15 Minutos', assunto: 'Poesia recitada'},
                { id: 3, titulo: 'Remorso', descricao: ' Áudio de 45 segundos ', assunto: 'Poesia recitada'},
                { id: 4, titulo: 'Trem de Alagos ', descricao: 'Áudio de  1,54 Minutos', assunto: 'Poesia recitada'},
